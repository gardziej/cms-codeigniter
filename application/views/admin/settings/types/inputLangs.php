        ...
        ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <input type="text" value="<?=set_value('dane['.$lang_id.']['.$f['cfg_name'].']', $f['lang_data'][$lang_id])?>" class="form-control"
                        name="dane[<?=$f['cfg_name']?>][<?=$lang_id?>]" placeholder="<?=$f['cfg_description']?>">
