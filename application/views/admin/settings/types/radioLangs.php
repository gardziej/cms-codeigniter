            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <?php
                        ...
                        foreach (json_decode($f['cfg_options']) AS $key => $nazwa)
                            {
                                echo '<label class="btn btn-default';
                                if ($key == $f['lang_data'][$lang_id]) echo ' active';
                                echo '">';
                                echo '<input name="dane['.$f['cfg_name'].']['.$lang_id.']" type="radio" value="'.$key.'"';
                                if ($key == $f['lang_data'][$lang_id]) echo ' checked';
                                echo '>';
                                echo $nazwa.'</label>';
                            }
                    ?>
